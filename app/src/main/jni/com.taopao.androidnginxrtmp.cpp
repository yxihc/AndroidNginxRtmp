...
Java_com_taopao_androidnginxrtmp_nginx_Nginx_startNative(JNIEnv* env, jobject thiz)
{
...
JNIEXPORT void JNICALL
Java_com_taopao_androidnginxrtmp_nginx_Nginx_stopNative(JNIEnv* env, jobject thiz)
{
...
JNIEXPORT void JNICALL
Java_com_taopao_androidnginxrtmp_nginx_Nginx_setPort(JNIEnv* env, jobject thiz, jint port)
{
	__android_log_print(ANDROID_LOG_ERROR, "jni_nginx", "Java_org_screenshare_rtmp_nginx_Nginx_setPort");
}

JNIEXPORT void JNICALL
com_taopao_androidnginxrtmp_nginx_Nginx_setHost(JNIEnv* env, jobject thiz, jstring host)
{
	__android_log_print(ANDROID_LOG_ERROR, "jni_nginx", "Java_org_screenshare_rtmp_nginx_Nginx_setHost");
}

JNIEXPORT void JNICALL
Java_com_taopao_androidnginxrtmp_nginx_Nginx_setConfigPath(JNIEnv* env, jobject thiz, jstring jstr_config)
{
...
Java_com_taopao_androidnginxrtmp_nginx_Nginx_getPrefixPath(JNIEnv* env, jobject thiz)
{
...
JNIEXPORT void JNICALL
Java_com_taopao_androidnginxrtmp_nginx_Nginx_setPrefixPath(JNIEnv* env, jobject thiz, jstring jstr_prefix)
{
